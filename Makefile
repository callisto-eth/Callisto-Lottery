...
NETWORK_ARGS := --rpc-url http://localhost:8545 --private-key $(ANVIL_DEFAULT_PRIVATE_KEY) --broadcast
...
deploy:
	@forge script script/DeployLottery.s.sol:DeployRaffle $(NETWORK_ARGS)
